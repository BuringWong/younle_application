...
/**
 * 作者：Create by 我是奋斗 on2016/12/28 14:47
 * 邮箱：tt090423@126.com
 * 微信：17346512596
 */
public class MtOrderDetail implements Serializable {
     ...
     * daySeq : 42
     * deliveryTime : 0
     * detail : [{"app_food_code":"food_code02","box_num":0,"box_price":0,"food_discount":1,"food_name":
     * "土豆泥餐","food_property":"","price":0.1,"quantity":3,"sku_id":"food_code02","spec":"","unit":""}]
     * dinnersNumber : 0
     * ePoiId : 8859
     * extras : [{"mt_charge":-1,"poi_charge":-1,"reduce_fee":-1,"remark":"","type":-1}]
     * fromplat : 1
     * hasInvoiced : 0
     * invoiceTitle :
     * isFavorites : true
     ...
     * longitude : 97.175624
     * orderId : 2949410963
     * orderIdView : 16653072059716805
     * originalPrice : 9.3
     * payType : 1
     * poiAddress : 南极洲04号站
     * poiFirstOrder : false
     * poiId : 1665307
     * poiName : kfpttest_zl13_42
     * poiPhone : 4009208801
     * poiReceiveDetail :
     * recipientAddress : 西藏昌都市气象局 (我)@#西藏自治区昌都市卡若区城关镇林廓路286号
     * recipientName : 王小渣(先生)
     * recipientPhone : 17346512596
     * shipperPhone :
     * shippingFee : 9
     * status : 2
     * total : 9.3
