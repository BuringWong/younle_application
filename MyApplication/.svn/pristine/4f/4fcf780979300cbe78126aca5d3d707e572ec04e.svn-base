...
final class DecodeHandler extends Handler {
  ...
  private void decode(byte[] data, int width, int height) {
    ...
    if (rawResult != null) {
      ...
      Message message = Message.obtain(handlerInterface.getHandler(), R.id.decode_succeeded, rawResult);
      ...
      Message message = Message.obtain(handlerInterface.getHandler(), R.id.decode_failed);
      message.sendToTarget();
    }
  }
