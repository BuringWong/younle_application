 ...
 * @author Ryan.Tang
 */
public class Voucheractivity extends Activity implements Callback,DecodeHandlerInterface {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.voucher_verification_orrefund);
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(Voucheractivity.this, "扫码失败", Toast.LENGTH_SHORT).show();
		} else {
//			System.out.println("Result:"+resultString);
		    mTvShow.setVisibility(View.VISIBLE);
			MyCount mMyCount = new MyCount(60000, 1000);
			mMyCount.start();
		}
	}
		class MyCount extends CountDownTimer{
			...
			public void onTick(long millisUntilFinished) {
				mTvShow.setGravity(Gravity.CENTER);
				mTvShow.setText("搜索代金券中......" + "\r\n" + millisUntilFinished / 1000);
				finish();
			}
