...
//      public static  final String BASE_URL1 = "http://pos.younle.com/App3";
//    public static  final String BASE_URL1 = "http://192.168.1.22/App2_3X";
...
//    public static final String UPDATE_LOG ="http://192.168.1.10/index" ;
     ...
     * 获取配送员列表
     */
    public static final String GET_STORE_SENDER =BASE_URL1+"/Order/getStoreDeliverman" ;
    /**
     * 提交配送员
     */
    public static final String SET_DEVLIVERMAN = BASE_URL1 + "/Order/assignDeliverman";
    /**
     * 更该门店营业状态
     */
    public static final String CHANGE_WXAPP_STATUS = BASE_URL1+"/Order/setStoreBusiness";

    /**
     * 轮询小程序订单    public static final String BASE_URL1 = "http://test.younle.com/App2";
     */
    public static final String GET_WXAPP_ORDER = BASE_URL1 + "/Order/getNewWxappOrder";
    /**
     * 提交退款订单
     */
