    ...
    public void analysisKeyEvent(KeyEvent event) {
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            if (aChar != 0) {
                ...
                LogUtils.e(TAG,"mStringBufferResult="+mStringBufferResult);
            }
...
//        Utils.showToast(context,"事件名称："+name);
//        return TextUtils.equals(name,"General Bluetooth HID Barcode Scanner")|| TextUtils.equals(name,"YLKJ_INSPIRY9");
        return TextUtils.equals(name,Constant.SCANNER_NAME)
                ||TextUtils.equals(name,"General Bluetooth HID Barcode Scanner")
                || name.contains("INSPIRY")
                ||TextUtils.equals(name,"Broadcom Bluetooth HID")
                ||TextUtils.equals(name, Constant.SM_XS)
                ||TextUtils.equals(name, "barcode scanner")
                ||name.contains("HID")||name.contains("hid");
