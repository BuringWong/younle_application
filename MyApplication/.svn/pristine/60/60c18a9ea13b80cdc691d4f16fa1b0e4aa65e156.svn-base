...
import com.younle.younle624.myapplication.domain.UsedRoom;
import com.younle.younle624.myapplication.domain.UsedTime;
...
public class OrderBean implements Serializable{
    ...
    private SaleMan.SalesBean.ContentBean saleMan;
    ...
    public SaleMan.SalesBean.ContentBean getSaleMan() {
        return saleMan;
    }

    public void setSaleMan(SaleMan.SalesBean.ContentBean saleMan) {
