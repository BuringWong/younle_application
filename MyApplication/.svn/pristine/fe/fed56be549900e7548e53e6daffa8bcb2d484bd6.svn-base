...
import com.younle.younle624.myapplication.adapter.ItemsRange;
import com.younle.younle624.myapplication.adapter.OnWheelChangedListener;
import com.younle.younle624.myapplication.adapter.OnWheelClickedListener;
import com.younle.younle624.myapplication.adapter.OnWheelScrollListener;
import com.younle.younle624.myapplication.adapter.OnWheelUpDownListener;
import com.younle.younle624.myapplication.adapter.WheelRecycle;
import com.younle.younle624.myapplication.adapter.WheelScroller;
import com.younle.younle624.myapplication.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private List<OnWheelUpDownListener> OnWheelUpDownListeners = new LinkedList<OnWheelUpDownListener>();
	...
	public void addUpDownListener(OnWheelUpDownListener listener) {
		OnWheelUpDownListeners.add(listener);
	}
	...
	protected void notifyUpDownListeners(boolean upDown) {//OnWheelUpDownListeners
		for (OnWheelUpDownListener listener : OnWheelUpDownListeners) {
			listener.onChanged(this, upDown);
		}
	}
	...
	private void drawShadows(Canvas canvas) {
		...
		int height = 6 * getItemHeight();//dzw 2017 0321 modify
		//*/
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.time_picker_current_background));//中间双线的颜色
		// 设置线宽
		paint.setStrokeWidth((float) 40);
		// 绘制上边直线 float startX, float startY, float stopX, float stopY
		//canvas.drawLine(0, center - offset, getWidth(), center - offset, paint);
		canvas.drawLine(0, center, getWidth(), center, paint);//dzw 2017 0321 modify
		// 绘制下边直线
		//canvas.drawLine(0, center + offset, getWidth(), center + offset, paint);
//		*/
//		centerDrawable.setBounds(0, center - offset, getWidth(), center + offset);
