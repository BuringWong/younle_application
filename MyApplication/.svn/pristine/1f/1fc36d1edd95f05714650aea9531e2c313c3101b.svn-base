 ...
 * 请求被扫支付API需要提交的数据
 */
public class ScanOrderPayData {
  //每个字段具体的意思请查看API文档
    private String auth_code = "";
    private String out_trade_time = "";
    private String total_fee = "";

    public ScanOrderPayData(String auth_code, String out_trade_time, String total_fee) {
    ...
    public void setOut_trade_time(String out_trade_no) {
        this.out_trade_time = out_trade_time;
    }
