package com.yongle.letuiweipad.domain.membercharge;
...
public class MemberChargeInfoBean {
    ...
    public static class MsgBean {
        ...
        public String getMember_cardno() {
            return member_cardno;
        }

        public void setMember_cardno(String member_cardno) {
            this.member_cardno = member_cardno;
        }
