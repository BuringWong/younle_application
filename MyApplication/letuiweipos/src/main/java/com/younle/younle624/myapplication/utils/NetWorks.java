...
import static com.younle.younle624.myapplication.constant.Constant.PARAMS_NEME_PASSDORD_MD5;
...
public class NetWorks {
    ...
    public Map<String,String> getPublicParams(){
        ...
        params.put(PARAMS_NEME_PASSDORD_MD5,MD5.md5(MD5.md5(Constant.PASSWORD)));
        return params;
    }

    public void Request(String url, Map<String,String> params, long time,final int flag,final OnNetCallBack callBack){
    ...
    public void PayCard(PayParams params, final OnNetCallBack callBack, final int flag) {
        ...
        publicParams.put("order_no",params.getOrderNo());
        publicParams.put("order_id",params.getOrderId());
        publicParams.put("payment",params.getPayMent());
        publicParams.put("total_fee",params.getTotal_fee());
        publicParams.put("vipcard_id",params.getVipId());
        ...
        Request(UrlConstance.PAY_ORDER_TOTALFEE,publicParams,10000,flag,callBack);
...
//                            callback.onError(e, flag);
    ...
    private void printLog(PayParams params) {
        ...
        LogUtils.e(TAG, "order_no=" + params.getOrderNo());
        LogUtils.e(TAG, "order_id=" + params.getOrderId());
        ...
        LogUtils.e(TAG, "vipcard_id=" + params.getVipId());
