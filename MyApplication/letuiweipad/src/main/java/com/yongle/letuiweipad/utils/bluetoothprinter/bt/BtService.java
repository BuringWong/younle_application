package com.yongle.letuiweipad.utils.bluetoothprinter.bt;
...
import com.yongle.letuiweipad.utils.bluetoothprinter.print.PrintMsgEvent;
import com.yongle.letuiweipad.utils.bluetoothprinter.print.PrintQueue;
import com.yongle.letuiweipad.utils.bluetoothprinter.print.PrinterMsgType;
...
public class BtService {
    ...
    public synchronized void connect(BluetoothDevice device) {
        LogUtils.Log("connect_to" + device);
    ...
    public synchronized void connected(BluetoothSocket socket,
        ...
        LogUtils.Log("socket_type" + socketType);
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                ...
                LogUtils.Log("Socket Type: " + mSocketType + "listen() failed" + e);
            }
            mmServerSocket = tmp;
        }
        ...
        public void run() {
            try {
                LogUtils.Log("Socket Type: " + mSocketType
                            ...
                            switch (mState) {
                                ...
                                case STATE_CONNECTED:
                                    ...
                                    try {
                                        ...
                                        LogUtils.Log("Could not close unwanted socket" + e);
                                    }
                                    break;
                            }
                        }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device) {
            ...
            try {
                ...
                LogUtils.Log("Socket Type: " + mSocketType + "create() failed" + e);
            }
            mmSocket = tmp;
        }
        ...
        public void run() {
            try {
                LogUtils.Log("BEGIN mConnectThread SocketType:" + mSocketType);
                ...
                try {
                    ...
                    try {
                        ...
                        LogUtils.Log("unable to close() " + mSocketType
        ...
        public void cancel() {
            try {
                ...
                LogUtils.Log("close() of connect " + mSocketType
                        + " socket failed" + e);
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            ...
            try {
                ...
                LogUtils.Log("temp sockets not created"+e);
            }
        ...
        public void run() {
            LogUtils.Log("BEGIN mConnectedThread");
        ...
        public void write(byte[] buffer) {
            try {
                ...
                LogUtils.Log("Exception during write"+e);
            }
        }
        ...
        public void cancel() {
            try {
                ...
                LogUtils.Log("close() of connect socket failed"+e);
            }
        }
    }
