package com.yongle.letuiweipad.utils.bluetoothprinter.print;
...
import com.yongle.letuiweipad.utils.bluetoothprinter.bt.BtService;
    ...
    public synchronized void print() {
        try {
            ...
            if (mBtService.getState() != BtService.STATE_CONNECTED) {
                LogUtils.Log("AppInfo的address"+ AppInfo.btAddress);
